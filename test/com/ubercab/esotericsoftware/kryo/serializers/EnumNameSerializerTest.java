...
import com.ubercab.esotericsoftware.kryo.KryoTestCase;
...
public class EnumNameSerializerTest extends KryoTestCase {
	public void testEnumNameSerializer () {
		...
		roundTrip(92, 92, TestNameEnum.WORLD);
		roundTrip(100, 100, TestAnotherNameEnum.MONDAY);
	}
	...
	public void testEnumNameSerializerWithMethods () {
		...
		roundTrip(105, 105, TestNameEnumWithMethods.ALPHA);
		roundTrip(104, 104, TestNameEnumWithMethods.BETA);
	}
